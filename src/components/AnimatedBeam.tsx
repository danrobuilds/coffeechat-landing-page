...
export function AnimatedBeamMultipleOutputDemo({
  ...
  return (
    <div
      className={cn(
        "relative flex h-[500px] max-w-5xl items-center justify-center overflow-hidden rounded-lg p-10 ",
        className,
      )}
      ref={containerRef}
    >
      <div className="relative flex size-full max-w-3xl flex-row items-stretch justify-between gap-48">
...
const Icons = {
  ...
  person: () => (
    <svg
        ...
        />
        <path
            d="M404.48 501.76h266.24v163.84h-266.24z"
            fill="#C7928E"
        />
        <path
        ...
        />
        <path
            d="M399.872 549.376l-84.48 88.064 138.24 102.4L541.184 670.72z"
            fill="#B6D5D0"
        />
        <path
            d="M673.28 549.376L757.76 637.44l-137.728 102.4L531.968 670.72z"
            fill="#B6D5D0"
        />
    </svg>
  ),
